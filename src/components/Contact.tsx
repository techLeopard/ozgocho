      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="h-full p-8 md:p-10 rounded-3xl bg-white/80 backdrop-blur-sm border border-gray-200/50 shadow-2xl flex flex-col">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 flex-grow flex flex-col">
                <div>
                  ...
                  <Input
                    ...
                    required
                    className="border-gray-300 bg-white/50 backdrop-blur-sm focus:bg-white transition-colors h-12 rounded-xl"
                  />
                </div>
                ...
                <div className="flex-grow flex flex-col">
                  ...
                  <Textarea
                    ...
                    className="border-gray-300 bg-white/50 backdrop-blur-sm focus:bg-white transition-colors flex-grow rounded-xl min-h-[120px]"
                  />
                </div>
                
                <Button 
                  type="submit" 
                  className="group w-full bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-700 hover:to-teal-800 text-white py-7 rounded-xl shadow-xl shadow-teal-500/30 hover:shadow-2xl hover:shadow-teal-500/40 transition-all duration-300 hover:scale-[1.02]"
                >
