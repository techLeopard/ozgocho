        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <div 
                  className={`group relative h-full p-6 md:p-8 rounded-3xl bg-white/70 backdrop-blur-sm border border-gray-200/50 hover:border-transparent overflow-hidden transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl ${service.shadow}`}
                >
                  ...
                  <div className="relative mb-4">
                    <div className={`inline-flex p-4 rounded-2xl bg-gradient-to-br ${service.gradient} shadow-lg transform group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500`}>
                      <Icon className="w-7 h-7 text-white" />
                    </div>
                  </div>
                  
                  <div className="relative">
                    <h3 className="mb-3 text-gray-800 group-hover:text-teal-700 transition-colors duration-300">
                      {service.title}
                    </h3>
