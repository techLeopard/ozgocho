        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          >
            ...
            <div className="space-y-4 text-teal-100">
              <div className="flex items-center gap-3 group transition-transform duration-200 hover:translate-x-1">
                <div className="p-2 bg-white/10 rounded-lg transition-colors duration-200 group-hover:bg-white/20">
          ...
          >
            ...
            <div className="flex gap-4">
              <a 
                href="#" 
                className="group w-12 h-12 bg-white/10 hover:bg-gradient-to-br hover:from-teal-500 hover:to-teal-600 rounded-xl flex items-center justify-center transition-all duration-200 hover:scale-105 hover:shadow-lg hover:shadow-teal-500/50"
                aria-label="Facebook"
              >
              ...
              <a 
                href="#" 
                className="group w-12 h-12 bg-white/10 hover:bg-gradient-to-br hover:from-orange-500 hover:to-pink-500 rounded-xl flex items-center justify-center transition-all duration-200 hover:scale-105 hover:shadow-lg hover:shadow-orange-500/50"
