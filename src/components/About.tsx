    ...
    <section className="py-24 md:py-32 bg-gradient-to-br from-white via-teal-50/50 to-orange-50/50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-teal-200/50 shadow-lg">
            ...
            <div className="space-y-5">
              {[
                ...
                <motion.div
                  ...
                  className="group flex items-start gap-4 p-4 rounded-2xl bg-white/50 backdrop-blur-sm hover:bg-white/80 hover:shadow-xl transition-all duration-300"
                >
                  <div className={`p-2 rounded-xl bg-gradient-to-br ${item.gradient} shadow-lg`}>
                    <CheckCircle className="w-5 h-5 text-white" />
                  </div>
                  <div className="flex-1">
                    <h4 className="text-gray-800 mb-1 group-hover:text-teal-700 transition-colors">{item.title}</h4>
          ...
          >
            <div className="col-span-2">
              <div className="relative group overflow-hidden rounded-3xl">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-teal-900/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </div>
            </div>
            ...
            <div className="relative group overflow-hidden rounded-3xl">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-orange-900/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            </div>
            
            <div className="relative group overflow-hidden rounded-3xl">
              <ImageWithFallback 
                src="https://images.unsplash.com/photo-1636772523547-5577d04e8dc1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzcGVjaWFsJTIwZWR1Y2F0aW9uJTIwY2xhc3Nyb29tfGVufDF8fHx8MTc1OTI4OTc0M3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                alt="Специальное обучение"
                className="w-full h-56 object-cover transform group-hover:scale-110 transition-transform duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-yellow-900/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            </div>
          </motion.div>
        </div>
      </div>
